...
<DIV id=view class="main wrap">
  <DIV class=intro>
    <DIV class=lefter>
      ...
      <DIV class=subinfo><fmt:formatDate value="${house.houseDate}" pattern="yyyy年MM月dd日"/></DIV>
      <DIV class=houseinfo>
        <P>户　　型：<SPAN>一室一厅</SPAN></P>
        <P>面　　积：<SPAN>${house.houseRect}m<SUP>2</SUP></SPAN></P>
        <P>位　　置：<SPAN>${house.houseLoc1}</SPAN></P>
        <P>联系方式：<SPAN>${house.user.userTel}</SPAN></P></DIV>
    </DIV>
    <DIV class=side>
