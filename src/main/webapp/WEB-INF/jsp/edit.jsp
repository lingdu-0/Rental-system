    ...
    <DIV class=dialog>
        ...
        <DIV class=box>
            <FORM id=add_action method=post name=add.action
                ...
                <input hidden value="${house.houseId}" name="houseId">
                <DIV class=infos>
                    <TABLE class=field>
                        <TBODY>
                        <TR>
                            <TD class=field>标　　题：</TD>
                            <TD><INPUT id=add_action_title class=text type=text name=title value="${house.houseName}">
                            </TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><INPUT id=add_action_floorage class=text type=text
                                       name=floorage value="${house.houseRect}"></TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD>
                                <INPUT class=text type=text name=houseDate value="${house.houseDate}">
                            </TD>
                        </TR>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><INPUT id=img class=text type=file name=houseImg></TD>
                        </TR>
                        <TR>
